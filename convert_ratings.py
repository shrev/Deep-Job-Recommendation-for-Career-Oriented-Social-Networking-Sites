...
ratings=pickle.load( open( "C:\\Users\\Shreya\\Documents\\MATLAB\\files\\ratings_1.txt", "rb" ) )
print len(ratings)
jobs=pandas.unique(ratings.item_id.ravel())
print jobs
initial_jobs=pandas.read_csv("C:\\Users\\Shreya\\Documents\\MATLAB\\data\\items.csv",delimiter="\t",index_col=None,error_bad_lines=False)
...
jobs.sort()
pickle.dump(clustered_jobs,open('C:\\Users\\Shreya\\Documents\\MATLAB\\files\\clustered_jobs_1.txt','wb'))
print jobs
...
sio.savemat('C:\\Users\\Shreya\\Documents\\MATLAB\\files\\ratings_1.mat', {'R':final_ratings})